...
public class CustomDialogs extends Dialog {
	...
	public CustomDialogs(Context context, int theme) {
		super(context, theme);
	}
	...
	public static class Builder {
		...
		public CustomDialogs create() {
			LayoutInflater inflater = (LayoutInflater) context
					.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			// instantiate the dialog with the custom Theme
			final CustomDialogs dialog = new CustomDialogs(context,R.style.Dialog);
			...
			if (message != null) {
				...
				((LinearLayout) layout.findViewById(R.id.message_llyt))
				.removeAllViews();
				((LinearLayout) layout.findViewById(R.id.message_llyt)).addView(
